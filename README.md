...
### What I work with
`Azure` · `Terraform` · `Bicep` · `GitHub Actions` · `AKS` · `Python` · `C#` · `AI Agents` · `Kubernetes`
...
---
*Currently exploring: agentic infrastructure and platform engineering for AI-native startups.*
